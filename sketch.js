...
function setup() {
	...
	roof = new Roof (425,200,500,50);
  base = new Base (425,450,500,50);
  sl = new Ss ();
  sr = new S()
	bobObject1 = new Bob (340,400,20)
	bobObject2 = new Bob (380,400,20)
	bobObject3 = new Bob (420,400,20)
	bobObject4 = new Bob (460,400,20)
	bobObject5 = new Bob (500,400,20);
